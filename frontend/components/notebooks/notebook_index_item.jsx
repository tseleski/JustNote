...
class NotebookIndexItem extends React.Component {
  constructor(props){
    super(props);
    const prevState = { modalIsOpen: false, actions_popup: false };
    this.state = Object.assign(prevState, this.props.notebook, this.props.deleteNotebook, this.props.errors);
