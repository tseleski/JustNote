...
Tagging.create!(note_id: note1.id, tag_id: tag2.id)
Tagging.create!(note_id: note1.id, tag_id: tag3.id)
Tagging.create!(note_id: note1.id, tag_id: tag4.id)
Tagging.create!(note_id: note2.id, tag_id: tag1.id)
Tagging.create!(note_id: note2.id, tag_id: tag2.id)
Tagging.create!(note_id: note2.id, tag_id: tag3.id)
Tagging.create!(note_id: note2.id, tag_id: tag4.id)
